...
public class GenerateResult {
	...
	public static void processSummary(String runId,String packageName){
		...
		//err@20
		SummaryAnalysis.extractERR_20("./"+packageName+"/summary.gdeval."+runId, "./"+packageName+"/err_20."+runId);
	...
	public static void processPrediction(String runId,String packageName) throws IOException{
		...
		predictorSD2.setQueryMap(QueryLength.getQueryLength("./"+packageName+"/2010queries_only"));
		 ...
		 */
		predictorWIG.setQueryMap(QueryLength.getQueryLength("./"+packageName+"/2010queries_only"));
		...
		predictorIA_SUM.IA_SUM.getIA_SUMScores("./"+packageName+"/input."+runId, "./"+packageName+"/input.indri2010subquery", "./"+packageName+"/output_middle", "./"+packageName+"/iA_SUMScore."+runId);
		...
		predictorIA_SUM.IASUM3.getIASUM3Scores("./"+packageName+"/input."+runId, "./"+packageName+"/input.indri2010subquery", "./"+packageName+"/output_middle", "./"+packageName+"/iASUM3Score."+runId);
		
		//计算CF
		predictorIA_SUM.CF.k_subquery=1000;//把子查询subquery的截断参数设为500
		predictorIA_SUM.CF.k_mainQuery=20;//把主查询mainQuery的截断参数设为20
		predictorIA_SUM.CF.getCFScores("./"+packageName+"/input."+runId, "./"+packageName+"/input.indri2010subquery", "./"+packageName+"/cFScore."+runId);
