...
/**
 * 这个类用于存储resultList_final信息,
 * <br>在20170309,增加了score变量,IASUM3也使用Struct_sum类
 * @author 1
 *
 */
class Struct_sum{
...
public class IA_SUM {
	...
	public static void generateIA_SUM(String output_middle,String output_later) throws IOException{
		...
		buffWriter.close();
		System.out.println("计算出IA-SUM结果,存入output_later文件,已完成..");
	}
	/**
	...
	/**
	 * 在06/13,使用了y=kx+b线性拟合
	 * 使用probability_subquery代替1.0/(60+rank)
	 * @return
	 */
	public static double getProbability_subquery(double rank){
		double probability=0;//存储最后的probability_subquery
		double part1=0;
		double part2=0;
	...
	public static void getIA_SUMScores(String input_runId,String input_subquery,String output_middle,String output_later) throws IOException{
		...
		System.out.println("计算IA_SUMScore,已完成..");
	}
	/**
	 * 
	 * @param args
