...
/**
 * changed on 20170312,暂时性修改。若NQC预测值为NaN,改为0,并输出修改的提示,
 * 在方法getNQCScores(String input, String output),作了修改<br>
 * @author 1
 *
 */
public class NQC {
	...
	public String convertNaN(String tempLine){
		...
		if(terms[3].equals("NaN")){
			...
			System.out.println("\n\n此条记录"+tempLine+" 中存在NaN值,已被改为0,并存入nQCScore.runId文件中。");
			return newTempLine;
		}else{
			return tempLine;
		}
